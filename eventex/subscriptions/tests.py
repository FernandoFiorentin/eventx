...
class SubscribeTest(TestCase):
    ...
    def test_csrf(self):
        """HTML must contais csrf token"""
        self.assertContains(self.resp, 'csrfmiddlewaretoken')

    def test_has_form(self):
        """Context must contains subscription form"""
...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Fernando Fiorentin', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('fernandoffiorentin@gmail.com', email.body)
        self.assertIn('54-99905-4297', email.body)
